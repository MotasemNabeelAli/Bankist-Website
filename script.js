...
/////////////////////////////////////////////////
// Functions
//convert currency to the local area
...
//convert the date to the local area
...
//create movement
const createMovement = function (value, i, date, account) {
  const movementType = value < 0 ? 'withdrawal' : 'deposit';
...
const displayMovements = function (account, movements) {
  ...
  movements.forEach(function (value, i) {
    containerMovements.insertAdjacentHTML(
      'afterbegin',
      createMovement(value.toFixed(2), i, account.movementsDates[i], account)
    );
  });
};
